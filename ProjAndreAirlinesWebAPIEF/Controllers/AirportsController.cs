...
namespace ProjAndreAirlinesWebAPIEF.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class AirportsController : ControllerBase
    {
        private readonly ProjAndreAirlinesWebAPIEFContext _context;

        public AirportsController(ProjAndreAirlinesWebAPIEFContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Airport>> PostAirport(Airport airport)
        {
            ...
            return CreatedAtAction("GetAirport", new { id = airport.Code }, airport);
        }
        ...
        {
            return _context.Airport.Any(e => e.Code == id);
        }
    }
}
